...
export default function Budget() {
    ...
    const d = q.data;
    return (_jsxs(_Fragment, { children: [_jsxs("h1", { children: ["Budget ", _jsx("span", { className: "fy", children: "FY2026-27" })] }), _jsx(GstBanner, { meta: d.meta }), _jsx(Notes, { notes: d.meta.notes }), _jsxs(Panel, { title: "Adjust the growth assumption", subtitle: "Resolution is most-specific-first: manager and quarter, then manager, then global. A dollar override supersedes the percentage at its level.", children: [_jsxs("div", { className: "form-row", children: [_jsxs("label", { children: ["Scope", _jsxs("select", { value: scope, onChange: (e) => setScope(e.target.value), children: [_jsx("option", { value: "global", children: "Global" }), _jsx("option", { value: "manager", children: "Manager" }), _jsx("option", { value: "manager_quarter", children: "Manager and quarter" })] })] }), scope !== "global" && (_jsxs("label", { children: ["Manager", _jsx("input", { value: manager, onChange: (e) => setManager(e.target.value), placeholder: "Sam Stewart" })] })), scope === "manager_quarter" && (_jsxs("label", { children: ["Quarter", _jsxs("select", { value: quarter, onChange: (e) => setQuarter(e.target.value), children: [_jsx("option", { value: "", children: "\u2026" }), [1, 2, 3, 4].map((n) => _jsxs("option", { value: n, children: ["Q", n] }, n))] })] })), _jsxs("label", { children: ["Growth %", _jsx("input", { value: pct, onChange: (e) => setPct(e.target.value), placeholder: "0.075" })] }), _jsxs("label", { children: ["Dollar override", _jsx("input", { value: dollars, onChange: (e) => setDollars(e.target.value), placeholder: "optional" })] }), _jsxs("label", { className: "grow", children: ["Reason", _jsx("input", { value: reason, onChange: (e) => setReason(e.target.value), placeholder: "why this assumption changed" })] }), _jsx("button", { disabled: reason.length < 3 || save.isPending, onClick: () => save.mutate({
                                    scope,
