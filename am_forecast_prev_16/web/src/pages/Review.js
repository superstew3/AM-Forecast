...
export default function Review() {
    ...
    const d = q.data;
    const c = d.counts;
    return (_jsxs(_Fragment, { children: [_jsxs("h1", { children: ["Matching review ", _jsx("span", { className: "fy", children: "forecast to actual" })] }), _jsx(GstBanner, { meta: d.meta }), _jsxs("div", { className: "purpose", children: [_jsx("strong", { children: "What this page is for." }), " Linking each forecast policy to the transaction that renewed it, so renewal achievement can be measured policy by policy. Most links are made automatically; this queue is only the ones the system will not decide on its own.", c.actionable < 20 && (_jsxs(_Fragment, { children: [" ", _jsx("em", { children: "Right now there is very little here, and that is expected." }), " ", "Matching needs a forecast period that overlaps transacted actuals, and you currently have only July 2026 with two policies. This page becomes useful once a second Renewals Pending file is loaded."] }))] }), _jsx(Panel, { title: "Queue composition", subtitle: "Only the first group needs individual decisions. The other two are bulk artefacts with a known cause and are separated so they cannot bury the real exceptions.", children: _jsxs("div", { className: "metric-grid", children: [_jsxs("div", { className: "metric metric-emphasis", children: [_jsx("div", { className: "metric-label", children: "Needs a decision" }), _jsx("div", { className: "metric-value", children: c.actionable }), _jsx("div", { className: "metric-sub", children: d.explanations.actionable })] }), _jsxs("div", { className: "metric", children: [_jsx("div", { className: "metric-label", children: "July timing artefacts" }), _jsx("div", { className: "metric-value", children: c.july_timing_artefacts }), _jsx("div", { className: "metric-sub", children: d.explanations.july_timing_artefacts })] }), _jsxs("div", { className: "metric", children: [_jsx("div", { className: "metric-label", children: "Outside matching scope" }), _jsx("div", { className: "metric-value", children: c.out_of_scope }), _jsx("div", { className: "metric-sub", children: d.explanations.out_of_scope })] })] }) }), _jsxs(Panel, { title: "Candidates", actions: _jsx("div", { className: "segmented", children: TABS.map((t) => (_jsx("button", { className: kind === t.key ? "on" : "", onClick: () => setKind(t.key), children: t.label }, t.key))) }), children: [kind !== "actionable" && (_jsxs("div", { className: "warning", children: ["These are explained in bulk and are not individual errors.", kind === "timing"
